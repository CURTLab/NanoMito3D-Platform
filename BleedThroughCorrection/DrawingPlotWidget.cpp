...
class DrawingPlotWidgetPrivate : public QwtPlot
{
public:
	...
	inline DrawingPlotWidgetPrivate(QWidget *parent)
		: QwtPlot(parent)
		, spectrogram(nullptr)
		, data(nullptr)
		, rescaler(nullptr)
...
DrawingPlotWidget::DrawingPlotWidget(QWidget *parent)
	: m_d(new DrawingPlotWidgetPrivate(this))
{
...
DrawingPlotWidget::~DrawingPlotWidget()
{
	delete m_d;
}

QImage DrawingPlotWidget::paintOverlay() const
{
	return {};
}

void DrawingPlotWidget::setPaintOverlay(QImage image) const
{

}

void DrawingPlotWidget::clearOverlay()
{

}

void DrawingPlotWidget::setImage(const cv::Mat &image)
{
	if (image.empty())
		return;
...
void DrawingPlotWidget::setPaintToolWidth(int width)
{

}

void DrawingPlotWidget::setPaintToolColor(QColor color)
{
